...
#### A full-stack web application built as for a mini presentation
<img src="./Images/aangGif.gif" alt="Image of resume"/>

<img src="./Images/Avatar_world_map.webp" style="width:100vw; height:100vh" alt="Resume video"/>
...
## Features
Users explore the resume of a quality new hire.
Users are able to click on referral links to contact references

## Whiteboard Images
*Original images will be updated on a later date.
...
* Allow users to ask an ai chat bot questions about the applicant.
* Allow users to see previous experience, videos/images.
* Users can change the theme.

## <a name="deployment"></a>Deployed Link
<!-- * [Netlify]([https://link.netlify.com](https://link.netlify.app)) -->

* [Github Pages](https://gr8ness21.github.io/avatarResume/)
